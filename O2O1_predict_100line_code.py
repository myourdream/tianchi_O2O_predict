# fork from 100行代码入门天池O2O优惠券使用新人赛【精简教程版】 python3
# # list datalab file
# !ls dataset
# ccf_offline_stage1_test_revised.csv  ccf_online_stage1_train.csv
...
def get_offline_feature(file, istrain):
    dfoff = pd.read_csv(file)
...
if __name__ == '__main__':
    ...
    dftest1.to_csv('submit3.csv', index=False, header=False)
    dftest1.head()
